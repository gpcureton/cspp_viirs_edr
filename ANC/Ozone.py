 ...
 * DESCRIPTION:  Class to granulate the ViirsAncOzone data product 
...
class Ozone() :
    ...
    def __init__(self,inDir=None, sdrEndian=None, ancEndian=None):
        self.collectionShortName = 'VIIRS-ANC-Tot-Col-Mod-Gran'
        self.xmlName = 'VIIRS_ANC_TOT_COL_MOD_GRAN.xml'
        self.blobDatasetName = 'totalColumnOzone'
