 ...
 * DESCRIPTION:  Class to granulate the ViirsAncSkinTemp data product 
...
try :
    ...
    LOG = logging.getLogger('SkinTemp')
...
class SkinTemp() :
    ...
    def __init__(self,inDir=None, sdrEndian=None, ancEndian=None):
        self.collectionShortName = 'VIIRS-ANC-Temp-Skin-Mod-Gran'
        self.xmlName = 'VIIRS_ANC_TEMP_SKIN_MOD_GRAN.xml'
        self.blobDatasetName = 'skinTemperature'
