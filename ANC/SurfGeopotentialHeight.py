...
# encoding: utf-8
"""
SurfGeopotentialHeight.py

 * DESCRIPTION:  Class to granulate the ViirsAncSurfGeopotentialHeight 
 *               data product 
...
LOG = logging.getLogger('SurfGeopotentialHeight')

collectionShortName = 'VIIRS-ANC-Geopot-Ht-Lev-Mod-Gran'
xmlName = 'VIIRS_ANC_GEOPOT_HT_LEV_MOD_GRAN.xml' # FIXME
blobDatasetName = 'surfaceGeopotentialHeight'
dataType = 'float32'
