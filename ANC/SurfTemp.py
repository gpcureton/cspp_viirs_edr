 ...
 * DESCRIPTION:  Class to granulate the ViirsAncSurfTemp data product 
...
try :
    ...
    LOG = logging.getLogger('SurfTemp')
...
class SurfTemp() :
    ...
    def __init__(self,inDir=None, sdrEndian=None, ancEndian=None):
        self.collectionShortName = 'VIIRS-ANC-Temp-Surf2M-Mod-Gran'
        self.xmlName = 'VIIRS_ANC_TEMP_SURF2M_MOD_GRAN.xml'
        self.blobDatasetName = 'surfaceTemperature'
