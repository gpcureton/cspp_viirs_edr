 ...
 * DESCRIPTION:  Class to granulate the ViirsAncWindSpeed data product 
...
try :
    ...
    LOG = logging.getLogger('WindSpeed')
...
class WindSpeed() :
    ...
    def __init__(self,inDir=None, sdrEndian=None, ancEndian=None):
        self.collectionShortName = 'VIIRS-ANC-Wind-Speed-Mod-Gran'
        self.xmlName = 'VIIRS_ANC_WIND_SPEED_MOD_GRAN.xml'
    ...
    def ingest(self,ancBlob=None):
        ...
        for gridBlobStruct in ancBlob:
            ...
            LOG.debug("VIIRS-ANC-Wind-Speed-Mod-Gran %s --> %s" % \
